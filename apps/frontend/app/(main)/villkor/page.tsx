      ...
      <article>
        ...
        <div className="space-y-8 text-foreground/80 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Du behöver ett konto för att använda Matrummet. Håll dina inloggningsuppgifter
              för dig själv. Ett konto per person.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              skulle tjänsten inte fungera. Du kan radera ditt innehåll när du vill.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">Vad du inte får göra</h2>
            <p className="mb-3">Matrummet är till för att hantera recept. Håll dig till det:</p>
          ...
          <section>
            ...
            <p>
              ...
              innan du lagar maten.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">Ansvar</h2>
            <p className="mb-3">
              Tjänsten ges i befintligt skick. Jag försöker hålla saker säkra och stabila,
              men kan inte garantera att data aldrig försvinner. Håll egna kopior av
              recept som är viktiga för dig.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Villkoren kan uppdateras. Använder du tjänsten efter en ändring räknas det
              som att du accepterar de nya villkoren.
            </p>
          </section>
        </div>
