...
import type { RecipeMatch, PantryItem, CommonPantryItem } from '@/lib/ingredient-search-types'
...
export function WhatCanIMake({ initialPantry = [], commonPantryItems = [] }: WhatCanIMakeProps) {
