 ...
 *   npx tsx scripts/optimize-existing-images.ts /opt/matrummet/public/uploads --dry-run
 *   npx tsx scripts/optimize-existing-images.ts /opt/matrummet/public/uploads
 */
