    ...
    <div className="rounded-lg border bg-card p-4">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {isFilterActive && (
            <span className="whitespace-nowrap rounded-full bg-primary px-2 py-0.5 text-xs text-primary-foreground">
      ...
      {!hasPantryItems && (
        <p className="mt-2 text-sm text-muted-foreground">
          ...
          <Link to="/mitt-skafferi" className="text-primary underline hover:no-underline">
            ditt skafferi
          </Link>{' '}
