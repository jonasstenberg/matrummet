...
-- Name: recept; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE recept WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';


ALTER DATABASE recept OWNER TO postgres;
...
-- Name: recept; Type: DATABASE PROPERTIES; Schema: -; Owner: postgres
--
