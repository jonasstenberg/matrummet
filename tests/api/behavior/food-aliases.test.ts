...
describe("Food Alias Behavior", () => {
  ...
  beforeAll(async () => {
    ...
    adminClient = await createAuthenticatedClient(TEST_USERS.admin.email);
  ...
  describe("in_pantry field in recipes_and_categories", () => {
    it("marks alias ingredient as in_pantry when canonical is in pantry", async () => {
      ...
      expectSuccess(result, "Failed to fetch recipes_and_categories");
